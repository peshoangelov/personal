function createMusicEducationQuiz() {
    ...
    const q16 = quiz.addGridItem();
    q16.setTitle('16. Напишете имената на нотните ключове от изображение 16:')
    q16.setRows(['Леви нотен ключ', 'Среден нотен ключ', 'Десен нотен ключ'])
    q16.setColumns(['Сол', 'Фа', 'До'])
    .setRequired(true);
    ...
    const q21 = quiz.addMultipleChoiceItem();
    ...
    const q27ai = quiz.addImageItem();
    q27ai.setImage(UrlFetchApp.fetch('https://files.pesho.net/filebrowser/api/public/dl/N3IDYSIV/milena_exam/27a.png'))
    .setTitle('Изображение 27а.');

    const q27a = quiz.addTextItem();
    q27a.setTitle('27a. Напишете имената на тоновете под нотния пример от изображение 27а.')
    .setPoints(20)
    .setRequired(true);

    const q27bi = quiz.addImageItem();
    q27bi.setImage(UrlFetchApp.fetch('https://files.pesho.net/filebrowser/api/public/dl/TWWc7i8H/milena_exam/27b.png'))
    .setTitle('Изображение 27б.');

    const q27b = quiz.addTextItem();
    q27b.setTitle('27б. Напишете имената на тоновете под нотния пример от изображение 27б.')
    .setPoints(20)
    .setRequired(true);
    ...
    const q29ai = quiz.addImageItem();
    q29ai.setImage(UrlFetchApp.fetch('https://files.pesho.net/filebrowser/api/public/dl/NvYPkbyk/milena_exam/29a.png'))
    .setTitle('Изображение 29а.');       
    const q29a = quiz.addTextItem();
    q29a.setTitle('29а. Напишете имената на знаците, които увеличават трайността на тоновете от изображение 29а.')
    .setPoints(7)
    .setRequired(true);

    const q29bi = quiz.addImageItem();
    q29bi.setImage(UrlFetchApp.fetch('https://files.pesho.net/filebrowser/api/public/dl/lkfidXbG/milena_exam/29b.png'))
    .setTitle('Изображение 29б.');       
    const q29b = quiz.addTextItem();
    q29b.setTitle('29б. Напишете имената на знаците, които увеличават трайността на тоновете от изображение 29б.')
    .setPoints(7)
    .setRequired(true);

    const q29ci = quiz.addImageItem();
    q29ci.setImage(UrlFetchApp.fetch('https://files.pesho.net/filebrowser/api/public/dl/6NFbt-zj/milena_exam/29c.png'))
    .setTitle('Изображение 29в.');       
    const q29c = quiz.addTextItem();
    q29c.setTitle('29в. Напишете имената на знаците, които увеличават трайността на тоновете от изображение 29в.')
    .setPoints(7)
    .setRequired(true);
